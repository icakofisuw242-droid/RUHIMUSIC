...
async def get_thumb(videoid):
    ...
    try:
        ...
        bg = Image.open(f"RishuMusic/assets/dil.png")
        ...
        font = ImageFont.truetype("RishuMusic/assets/font2.ttf", 45)
        font2 = ImageFont.truetype("RishuMusic/assets/font2.ttf", 70)
        arial = ImageFont.truetype("RishuMusic/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("RishuMusic/assets/font.ttf", 30)
        para = textwrap.wrap(title, width=30)
        j = 0
        draw.text((30, 10), f"{MUSIC_BOT_NAME}", fill="white", font=name_font)
        for line in para:
            if j == 1:
                j += 1
                draw.text(
