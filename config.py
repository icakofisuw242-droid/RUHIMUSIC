...
START_STICKER_ID = getenv("START_STICKER_ID", "CAACAgIAAxkBAAIoiGnxuuv9ovLau0NYqpNFGOeMaLTYAAJSkwAC3bzAS_sY8v7d1y0JHgQ")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
YTPROXY_URL = getenv("YTPROXY_URL", 'https://tgapi.xbitcode.com') ## xBit Music Endpoint.
YT_API_KEY = getenv("YT_API_KEY" , 'xbit_FoPZuIwe2QtqAbVbc1Yc2YLWqk1Phhqe' )
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Megalalon/AjNormalMusic",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/samantha_hot_pics")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/samantha_hot_pics")
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://ibb.co/HfN4bRwH")
